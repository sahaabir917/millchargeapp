...
class _AddCreditPageState extends State<AddCreditPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // final LoginController DebitAmountTextEditor = Get.put(LoginController());
                ...
                onPressed: () {
                  ...
                  handleCreditInformation(
                      ...
                      creditDescription == null
                          ? "No description"
                          : creditDescription,
                      creditAmount == null ? "0" : creditAmount,
                      creditShortNote == null ? "No notes" : creditShortNote,
                      creditDate.toString());
                },
              ),
            ),
  ...
  void handleCreditInformation(
    ...
    print("credit note is $creditShortNote");
    ...
    var response = await creditTransactionController.addCredit(
        ...
        creditAmount,
        creditShortNote,
        creditDate.substring(0, 10),
        _selectedFile,
        "credit");
    if (response == true) {
      generalController.getAllGeneralInfo();
      creditTransactionController.getRecentCreditTransactions();
      Navigator.pop(context);
      Navigator.pop(context);
    }
  }
